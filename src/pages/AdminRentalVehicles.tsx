        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
              ...
              <div className="space-y-2">
                <label htmlFor="daily" className="text-sm font-medium">Daily Rate ($)</label>
                <Input 
                  id="daily" 
                  type="number"
              ...
              <div className="space-y-2">
                <label htmlFor="weekly" className="text-sm font-medium">Weekly Rate ($)</label>
                <Input 
                  id="weekly" 
                  type="number"
              ...
              <div className="space-y-2">
                <label htmlFor="monthly" className="text-sm font-medium">Monthly Rate ($)</label>
                <Input 
                  id="monthly" 
                  type="number"
            ...
            <TableBody>
              {vehicles.map((vehicle) => (
                <TableRow key={vehicle.id}>
                  ...
                  <TableCell>${vehicle.rate.daily.toFixed(2)}</TableCell>
                  <TableCell>
