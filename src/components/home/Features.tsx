    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-booba-dark">Why Choose Booba Taxi</h2>
          ...
          {features.map((feature, index) => (
            <Card key={index} className="border-none shadow-lg card-hover">
              <CardContent className="p-6 text-center">
                <div className="mx-auto mb-4 w-16 h-16 bg-booba-yellow rounded-full flex items-center justify-center">
                  <feature.icon className="h-8 w-8 text-booba-dark" />
                </div>
